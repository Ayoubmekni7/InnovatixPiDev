...
class Project
{
    ...
    #[ORM\OneToOne(targetEntity: Investissement::class, mappedBy: 'project', cascade: ['persist', 'remove'])]
    ...
    public function setInvestissement(?Investissement $investissement): self
    {
        ...
        if ($investissement === null) {
            ...
            $investissement->setProject(null);
        } elseif ($investissement->getProject() !== $this) {
            // set the owning side of the relation if necessary
            $investissement->setProject($this);
        }
